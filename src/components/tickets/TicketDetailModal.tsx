      ...
      <div className="p-6 space-y-6">
            ...
            {ticket.status === 'Open' || ticket.status === 'Reopened' ? (
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white font-bold text-xs rounded-xl"
                  type="button"
                >
                  Mark resolved
                </button>
        ...
        {(currentUser?.role === 'org_owner' ||
          ...
          canAssign && (
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/80 border space-y-3">
              <div className="font-bold text-xs flex items-center gap-1.5">
                <User className="w-4 h-4 text-blue-600" /> Assign technician
              </div>
              <div className="flex gap-2">
                <select
                  value={selectedTechId}
                  onChange={(e) => setSelectedTechId(e.target.value)}
                  className="flex-1 px-3 py-2 rounded-xl border text-xs bg-white dark:bg-slate-900"
                >
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-3 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white rounded-xl"
              type="button"
            >
