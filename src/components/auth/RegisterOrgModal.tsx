...
import {
  X, Building2, ShieldAlert, Users, ArrowRight, ArrowLeft, Calculator,
} from 'lucide-react';
...
export const RegisterOrgModal: React.FC<Props> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const [propertyType, setPropertyType] = useState('Shopping Centre');
  ...
  const tierBaseFee = tier === 'Starter' ? 1450 : tier === 'Professional' ? 3850 : 8900;
        ...
        {submitted ? (
          <div className="p-8 text-center space-y-4">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300 max-w-md mx-auto">
              <strong>{companyName}</strong> is now <em>Pending Approval</em>. A Super Admin will
              review and issue your unique organisation code.
            </p>
          </div>
        ) : (
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {[
                      ...
                      <div key={s.label} className="p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        ...
                        <input type="number" min={0} value={s.value}
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input required value={propertyName} onChange={(e) => setPropertyName(e.target.value)}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input type="number" min={0} value={tenantCount}
                ...
                <div>
                  ...
                  <input type="number" min={0} value={estimatedMonthlyRental}
                  ...
                  {(['Starter', 'Professional', 'Enterprise'] as SubscriptionTier[]).map((t) => (
                    <div
                      ...
                      className={`p-4 rounded-xl border-2 cursor-pointer ${
                        tier === t ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-950/40'
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700 space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs pt-2 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <div>
                      ...
                      <div className="font-extrabold text-blue-600">E{totalEstimate.toLocaleString()}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button type="submit" disabled={loading}
                  ...
                  <span>{loading ? 'Submitting…' : step === 3 ? 'Submit' : 'Continue'}</span>
