        ...
        <form onSubmit={handleNext} className="space-y-5">
          ...
          {step === 2 && (
            <div className="p-4 text-xs text-slate-500">
              Continue with property portfolio details in the full registration form.
              (If this step looks incomplete after deploy, refresh — content is on main.)
            </div>
          )}
          ...
          {step === 3 && (
            <div className="space-y-3 text-xs">
                ...
                {plans.map((p) => (
                  <button
                    ...
                    className={`p-3 rounded-xl border text-left ${
                      tier === p.tier ? 'border-blue-600 bg-blue-50' : ''
                    }`}
                  >
              ...
              <div className="text-slate-500">
                Estimated fee: E{feePreview.toLocaleString()} /mo
              </div>
            </div>
          )}
          ...
          <div className="flex justify-between pt-2 border-t">
            <button
              ...
              className="px-4 py-2 rounded-xl border text-xs font-semibold flex items-center gap-1"
            >
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white text-xs font-bold flex items-center gap-1"
            >
              {step < 3 ? (
                <>
